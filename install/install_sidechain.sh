...
cat > $CONF_FILE <<EOL
{
    ...
    "API_PARTICIPANT_NUMBER": ${API_PARTICIPANT_NUMBER},
    "WITNESSORG_PARTICIPANT_NUMBER": ${WITNESSORG_PARTICIPANT_NUMBER},
    "CHILDTYPE1_PARTICIPANT_NUMBER": ${CHILDTYPE1_PARTICIPANT_NUMBER},
    "PARENTTYPE1_PARTICIPANT_NUMBER": ${PARENTTYPE1_PARTICIPANT_NUMBER},
    "INVESTORTYPE1_PARTICIPANT_NUMBER": ${INVESTORTYPE1_PARTICIPANT_NUMBER},
    "COSIGNERORG_PARTICIPANT_NUMBER": ${COSIGNERORG_PARTICIPANT_NUMBER},
