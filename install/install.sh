...
apt update -q=2 -y && apt full-upgrade -y -qq  > /dev/null
apt install curl git jq wget lsb-release apt-transport-https ca-certificates sed dos2unix -y -qq  > /dev/null
