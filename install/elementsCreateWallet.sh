...
function elementsCreateWallet() {
  ...
  local E_CLI_GETRAWMEMPOOL="${CLI_WALLET} getrawmempool"
  local E_CLI_GENERATEBLOCK="${CLI_WALLET} generateblock"
  local E_CLI_GENERATE="${CLI_WALLET} generate"
  ...
  cat > $CODE_CONF_FILE <<EOL
{
  ...
  "E_CLI_GETRAWMEMPOOL": "${E_CLI_GETRAWMEMPOOL}",
  "E_CLI_GENERATEBLOCK": "${E_CLI_GENERATEBLOCK}",
  "E_CLI_GENERATE": "${E_CLI_GENERATE}",
